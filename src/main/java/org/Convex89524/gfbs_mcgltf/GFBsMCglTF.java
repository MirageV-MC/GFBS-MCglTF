package org.Convex89524.gfbs_mcgltf;
...
import com.modularmods.mcgltf.*;

@Mod(GFBsMCglTF.MODID)
@Mod.EventBusSubscriber(value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.MOD)
public class GFBsMCglTF {

    public static final String MODID = "gfbs_mcgltf";
    public static final String RESOURCE_LOCATION = "resourceLocation";

    public static final Logger logger = LogManager.getLogger(MODID);

    private static GFBsMCglTF INSTANCE;
    ...
    public static void onEvent(RegisterClientReloadListenersEvent event) {
        INSTANCE.lightTexture = Minecraft.getInstance().getTextureManager().getTexture(new ResourceLocation("minecraft", "dynamic/light_map_1"));
    ...
    public static GFBsMCglTF getInstance() {
        return INSTANCE;
    }
