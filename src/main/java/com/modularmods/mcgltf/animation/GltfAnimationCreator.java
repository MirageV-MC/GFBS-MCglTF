...
public final class GltfAnimationCreator {
	...
	public static List<InterpolatedChannel> createGltfAnimation(AnimationModel animationModel) {
		...
		for(Channel channel : channels) {
			...
			{
				GFBsMCglTF.logger.warn("Input data is not an AccessorFloatData, but "
						+ inputData.getClass());
				continue;
			}
			...
			{
				GFBsMCglTF.logger.warn("Output data is not an AccessorFloatData, but "
						+ outputData.getClass());
				continue;
			}
			...
			case "translation":
				...
				case CUBICSPLINE:
					...
					break;
				default:
					GFBsMCglTF.logger.warn("Interpolation type not supported: " + interpolation);
					break;
				}
				break;
			case "rotation":
			...
			case "weights":
				...
				break;
			default:
				GFBsMCglTF.logger.warn("Animation channel target path must be "
